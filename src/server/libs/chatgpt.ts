...
export class ChatGPTClient {
  static readonly BASE = "https://chatgpt.com";
  static readonly RESPONSES_PATH = "/backend-api/codex/responses";
  static readonly USAGE_URL = `${ChatGPTClient.BASE}/backend-api/wham/usage`;
  private static readonly VERSION = "0.133.0";
  private static readonly UA = `codex_cli_rs/${ChatGPTClient.VERSION} (Mac OS; arm64)`;
  ...
  httpHeaders(accept = "text/event-stream"): Headers {
    ...
    h.set("Origin", ChatGPTClient.BASE);
    h.set("Referer", `${ChatGPTClient.BASE}/`);
    h.set("Originator", "codex_cli_rs");
    h.set("Version", ChatGPTClient.VERSION);
    h.set("User-Agent", ChatGPTClient.UA);
    h.set("Accept", accept);
...
export const CHATGPT_BASE = ChatGPTClient.BASE;
export const CODEX_RESPONSES_PATH = ChatGPTClient.RESPONSES_PATH;
export const CODEX_USAGE_URL = ChatGPTClient.USAGE_URL;
export const buildCodexHttpHeaders = (account: Account, accept?: string) => new ChatGPTClient(account).httpHeaders(accept);
export const buildWebSocketHeaders = (base: Record<string, string> | undefined, account: Account) => new ChatGPTClient(account).wsHeaders(base);
export const isRateLimitText = ChatGPTClient.isRateLimit.bind(ChatGPTClient);
export const isStreamFailureBody = ChatGPTClient.isStreamFailure.bind(ChatGPTClient);
export const detectStreamError = ChatGPTClient.detectError.bind(ChatGPTClient);
export const isSseSuccessBlock = ChatGPTClient.isSuccessBlock.bind(ChatGPTClient);
export const detectTokenUsage = ChatGPTClient.detectTokenUsage.bind(ChatGPTClient);
export const decodeTokenInfo = ChatGPTClient.decodeToken.bind(ChatGPTClient);
export const probeWebSocketAccount = (
  upstreamUrl: string,
  base: Record<string, string> | undefined,
  account: Account,
  original?: string | Buffer
) => new ChatGPTClient(account).probe(upstreamUrl, base, original);
export const findWebSocketLimitSnippet = ChatGPTClient.findLimitSnippet.bind(ChatGPTClient);
export const retryAfterMsFromSnippet = ChatGPTClient.retryAfterMs.bind(ChatGPTClient);
export const isWebSocketSuccessPayload = ChatGPTClient.isSuccessPayload.bind(ChatGPTClient);
export const compactWebSocketPayload = ChatGPTClient.compactPayload.bind(ChatGPTClient);
export const buildProbeMessage = ChatGPTClient.buildProbeMessage.bind(ChatGPTClient);
